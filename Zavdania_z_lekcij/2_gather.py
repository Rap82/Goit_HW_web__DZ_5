...
# +++++++++++++++++++++++++++ Основне задання реалізувати дві функція для отримання результату роботи з БД синхроним і асинхроним методом кодування ++++++++++++++++++
...
async def main(): # Реалізація основниї функції *main() асинхоним метод.
    ...
    for i in range(1,5): # Цикл в якому генеруємо 4 випадковх рядків з БД *Faker("uk-UA") з id від 1 до 5 (невключно)
        users.append(async_get_user_from_db (i)) # додаємо до списку *users  результати роботи нашої функції *async_get_user_from_db (i)
